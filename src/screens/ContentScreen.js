...
const ContentScreen = ({ navigation }) => {
  return (
    <Box _dark={{bg:"#4F5B57"}} _light={{bg:"#E2D5C3"}} width="390" height="682">
      ...
      <Text marginTop={5} marginLeft={4} marginBottom={3} color="#4F5B57">最近喜歡聽的歌</Text>
      <Box _dark={{bg:"#4F5B57"}} _light={{bg:"#4F5B57"}} width={377} height={0.5}  marginLeft={2} marginBottom={3}></Box>
    <HStack>
        <Image
